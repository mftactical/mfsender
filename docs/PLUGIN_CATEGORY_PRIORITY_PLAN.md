...
#### RapidChangeATC (`plugins/com.mfsender.rapidchangeatc/manifest.json`)
- Add: `"category": "tool-changer"`
- Add: `"priority": 50` (needed - registers `onBeforeCommand`)

#### Surfacing (`plugins/com.mfsender.surfacing/manifest.json`)
- Add: `"category": "gcode-generator"`
- No priority field (not needed - tool-only plugin)

#### AutoDustBoot (`plugins/com.mfsender.autodustboot/manifest.json`)
