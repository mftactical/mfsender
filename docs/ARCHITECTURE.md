...
graph LR
    ...
    Machine["CNC Machine\n(serial / tcp)"]
    Server["mfsender Server (Electron + Express + WS) - Can be one of the client too"]
...
sequenceDiagram
    ...
    participant Hub as mfsender Server
