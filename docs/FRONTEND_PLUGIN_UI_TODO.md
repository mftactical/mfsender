...
## Current State
- File: `/Users/francis/projects/mfsender/app/client/src/features/plugins/PluginsTab.vue`
...
In `/Users/francis/projects/mfsender/app/client/src/features/plugins/api.ts`, update the `PluginListItem` interface to include:
