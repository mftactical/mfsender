# Developer Guide — mfsender

This guide covers the codebase layout, development workflow, build scripts, and release process for mfsender.
...
```bash
git clone --recursive git@github.com:siganberg/mfsender.git
```
...
cd plugins/com.mfsender.rapidchangeatc
...
cd ../..
git add plugins/com.mfsender.rapidchangeatc
...
**Plugin repositories:**
- [autodustboot](https://github.com/siganberg/mfsender-plugin-autodustboot)
- [rapidchangeatc](https://github.com/siganberg/mfsender-plugin-rapidchangeatc)
- [surfacing](https://github.com/siganberg/mfsender-plugin-surfacing)
