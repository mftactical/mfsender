...
Thanks for your interest in improving mfsender! This repository follows a Vertical (feature‑sliced) architecture and a Client–Server–Device (CSD) runtime model. Please follow these guidelines when opening a PR.
