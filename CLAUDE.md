...
This file contains development preferences and patterns to follow when working on the mfsender project.

## File Paths

### Plugin Development
- **CRITICAL**: Always edit plugin source code in `/mfsender.plugins/` directory
- **NEVER**: Edit plugins in production path (`~/Library/Application Support/mfsender/plugins/`)
- **Source Locations**:
  - Plugin source: `/Users/francis/projects/mfsender/mfsender.plugins/`
  - Production path: `/Users/francis/Library/Application Support/mfsender/plugins/` (READ ONLY for reference)
