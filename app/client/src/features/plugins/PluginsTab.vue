    ...
    <div v-else class="plugins-content">
      ...
      <div class="plugins-scrollable">
        <div v-if="plugins.length === 0 && !loading" class="empty-state">
          ...
          <p class="empty-hint">Install a plugin to extend mfsender functionality</p>
        </div>
...
const REGISTRY_URL = 'https://raw.githubusercontent.com/siganberg/mfsender.plugins-registry/main/plugins.json';
